...
Parenthesis are always implicit in Reverse Polish Notation, meaning an expression is evaluated from left to right. All of the 
...
class  TestProgram(unittest.TestCase):
    def test_case_1(self):
        ...
        tokens = ["SO", "3", "17", "+", "2", "-", "/"]
        self.assertEqual(ProgrammingError.reversePolishNotation(tokens), 2)

    def test_case_2(self):
        tokens = ["4", "13", "5", "/", "+"]
        self.assertEqual(ProgrammingError.reversePolishNotation(tokens), 6)
