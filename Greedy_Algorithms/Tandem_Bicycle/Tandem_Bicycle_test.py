...
class  TestProgram(unittest.TestCase):
    def test_case_1(self):
        self.assertEqual(ProgrammingError.tandemBicycle([5, 5, 3, 9, 2], [3, 6, 7, 2, 1], True), 32)

    def test_case_2(self):
        self.assertEqual(ProgrammingError.tandemBicycle([1, 2, 1, 9, 4], [3, 6, 4, 2, 1], False), 25)

    def test_case_3(self):
        self.assertEqual(ProgrammingError.tandemBicycle([1, 2, 1, 9, 4], [3, 6, 4, 2, 1], True), 32)
