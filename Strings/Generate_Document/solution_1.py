...
#O(m+n) time | O(c) space - where m is the number of characters, n is the length of the document, and c is the number of unique characters in the characters string
