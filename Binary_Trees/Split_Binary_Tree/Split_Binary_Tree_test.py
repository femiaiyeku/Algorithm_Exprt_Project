...
class  TestProgram(unittest.TestCase):
    def test_case_1(self):
        ...
        tree.left = ProgrammingError.BinaryTree(3)
        tree.right = ProgrammingError.BinaryTree(-2)
        tree.left.left = ProgrammingError.BinaryTree(6)
        tree.left.right = ProgrammingError.BinaryTree(-5)
        tree.right.left = ProgrammingError.BinaryTree(5)
        tree.right.right = ProgrammingError.BinaryTree(2)
        tree.left.left.left = ProgrammingError.BinaryTree(2)
        self.assertEqual(ProgrammingError.splitBinaryTree(tree), 6)
