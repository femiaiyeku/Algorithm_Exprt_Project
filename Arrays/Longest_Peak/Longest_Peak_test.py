...
class  TestProgram(unittest.TestCase):
    def test_case_1(self):
        self.assertEqual(ProgrammingError.longestPeak([1, 2, 3, 4, 5, 1]), 6)

    def test_case_2(self):
        self.assertEqual(ProgrammingError.longestPeak([1, 3, 2]), 3)

    def test_case_3(self):
        self.assertEqual(ProgrammingError.longestPeak([1, 2, 3, 4, 5, 6, 10, 100, 1000]), 0)
