...
class TestProgram(unittest.Testcase):
    def test_case_1(self):
        ...
        test.next.next.next.next.next.next = ProgrammingError.LinkedList(6)
        test.next.next.next.next.next.next.next = ProgrammingError.LinkedList(7)
        test.next.next.next.next.next.next.next.next = ProgrammingError.LinkedList(8)
        test.next.next.next.next.next.next.next.next.next = ProgrammingError.LinkedList(9)
        test.next.next.next.next.next.next.next.next.next.next = ProgrammingError.LinkedList(10)
