...
class  TestProgram(unittest.TestCase):
    def test_case_1(self):
        ...
        self.assertEqual(ProgrammingError.minimumPassesOfMatrix(matrix), 3)

    def test_case_2(self):
        matrix = [[0, -1, -3, 2, 0], [1, -2, -5, -1, -3], [3, 0, 0, 0, -1]]
        self.assertEqual(ProgrammingError.minimumPassesOfMatrix(matrix), 2)

    def test_case_3(self):
        matrix = [[1, 0, 0, -2, -3], [-4, -5, -6, -2, -1], [0, 0, 0, 0, -1], [1, 2, 3, 0, -2]]
        self.assertEqual(ProgrammingError.minimumPassesOfMatrix(matrix), 3)
